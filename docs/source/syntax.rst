...
:values: (:py:attr:`~ast.DataType.ARRAY` of *anything*) An array of values to check.
...
:values: (:py:attr:`~ast.DataType.ARRAY` of :py:attr:`~ast.DataType.FLOAT`) An array of values to add.

Returns the sum of an array of values. If *values* is empty, the function returns 0.

``ARRAY[??] map(FUNCTION function, ARRAY[??] values)``

:returns: :py:attr:`~ast.DataType.ARRAY` of *anything*
:function: (:py:attr:`~ast.DataType.FUNCTION`) The function to call on each of the values.
:values: (:py:attr:`~ast.DataType.ARRAY` of *anything*) The array of values to apply *function* to.

``FLOAT max(ARRAY[FLOAT] values)``

:returns: :py:attr:`~ast.DataType.FLOAT`
:values: (:py:attr:`~ast.DataType.ARRAY` of :py:attr:`~ast.DataType.FLOAT`) An array of values to check.
...
:returns: :py:attr:`~ast.DataType.DATETIME`
:value: (:py:attr:`~ast.DataType.STRING`) The string value to parse into a timestamp.

Parses the string value into a :py:attr:`~ast.DataType.DATETIME` value. The string must be in ISO-8601 format and if it
fails to parse, a :py:exc:`~.errors.DatetimeSyntaxError` is raised.

``FLOAT parse_float(STRING value)``

:returns: :py:attr:`~ast.DataType.FLOAT`
:value: (:py:attr:`~ast.DataType.STRING`) The string value to parse into a numeric.

Parses the string value into a :py:attr:`~ast.DataType.FLOAT` value. The string must be properly formatted and if it
fails to parse, a :py:exc:`~.errors.FloatSyntaxError` is raised.

``FLOAT parse_timedelta(STRING value)``

:returns: :py:attr:`~ast.DataType.TIMEDELTA`
:value: (:py:attr:`~ast.DataType.STRING`) The string value to parse into a time period.

Parses the string value into a :py:attr:`~ast.DataType.TIMEDELTA` value. The string must be properly formatted and if it
fails to parse, a :py:exc:`~.errors.TimedeltaSyntaxError` is raised.

``FLOAT random([FLOAT boundary])``

:returns: :py:attr:`~ast.DataType.FLOAT`
:boundary: (Optional :py:attr:`~ast.DataType.FLOAT`) The upper boundary to generate a random number for.
...
:returns: :py:attr:`~ast.DataType.ARRAY` of :py:attr:`~ast.DataType.STRING`
:string: (:py:attr:`~ast.DataType.STRING`) The string value to split into substrings.
:sep: (Optional :py:attr:`~ast.DataType.STRING`) The value to split *string* on.
:maxsplit: (Optional :py:attr:`~ast.DataType.FLOAT`) The maximum number of times tp split *string*.
